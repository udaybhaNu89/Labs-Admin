...
if (isset($_GET['move_section']) && isset($_GET['dir'])) {
    ...
    header("Location: storage_management.php"); exit();
}
...
<div class="priority-box">
    ...
    <div id="prio_list_storage" style="display:none;">
        ...
        foreach($all_secs as $sec) {
            ...
            echo "<a href='storage_management.php?move_section=".$sec['id']."&dir=up' class='$up_class'>&uarr;</a>";
            echo "<a href='storage_management.php?move_section=".$sec['id']."&dir=down' class='$down_class'>&darr;</a>";
            echo "</div></div>";
        }
        ?>
    </div>
        ...
        <div class="column">
            ...
            <div id="<?php echo $act_id; ?>" class="action-bar" style="display:none;">
                ...
                <div class="remove-wrapper">
                    <a href="storage_management.php?remove_section=<?php echo $sid; ?>" id="rem_st_<?php echo $sid; ?>" class="btn-action-remove disabled" onclick="return confirm('Remove this field? Data in this column will be lost.');">Remove Field</a>
